...
function tocarSomTiro() {
    ...
    indiceSomTiro = (indiceSomTiro + 1) % sons.tiro.length; // Pula para o próximo som do estoque
}
...
function tocarSomSpawn() {
    ...
    indiceSomSpawn = (indiceSomSpawn + 1) % sons.spawn.length; // Pula para o próximo som do estoque
}
